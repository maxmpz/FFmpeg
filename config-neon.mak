...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-cross-compile --cc=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --as=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --sysinclude=/opt/android-ndk-r10d/platforms/android-14/arch-arm/usr/include --nm=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-nm --extra-ldflags='--sysroot=/opt/android-ndk-r10d/platforms/android-14/arch-arm -Wl,--no-whole-archive /opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/lib/gcc/arm-linux-androideabi/4.9/libgcc.a -Wl,--no-undefined -Wl,-z,noexecstack -L/opt/android-ndk-r10d/platforms/android-14/arch-arm/usr/lib -llog -lz -lc -Wl,--no-warn-mismatch -lm_hard' --enable-small --enable-pic --disable-runtime-cpudetect --disable-symver --disable-pixelutils --disable-doc --disable-dxva2 --disable-debug --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-swscale --disable-avfilter --disable-everything --disable-network --disable-vaapi --disable-vdpau --disable-pthreads --enable-protocol=file --enable-protocol=pipe --enable-protocol=http --enable-protocol=rtp --enable-decoder=aac --enable-decoder=mp3float --enable-decoder=mp2float --enable-decoder=mp3on4float --enable-decoder=mp3adufloat --enable-decoder=vorbis --enable-decoder=wmav1 --enable-decoder=wmav2 --enable-decoder=alac --enable-decoder=mace3 --enable-decoder=mace6 --enable-decoder=wmapro --enable-decoder=wmalossless --enable-decoder=ape --enable-decoder=tta --enable-decoder=flac --enable-decoder=opus --enable-decoder=tak --enable-decoder='dsd_*' --enable-parser=opus --enable-parser=flac --enable-demuxer=flac --enable-parser=vorbis --enable-parser=tak --enable-demuxer=tak --enable-demuxer=dsf --enable-demuxer=iff --enable-decoder=mpc7 --enable-decoder=mpc8 --enable-demuxer=mpc --enable-demuxer=mpc8 --enable-demuxer=wav --enable-demuxer=flv --enable-demuxer=mp3 --enable-demuxer=mov --enable-demuxer=asf --enable-demuxer=gsm --enable-demuxer=aiff --enable-demuxer=ape --enable-demuxer=aac --enable-demuxer=ogg --enable-demuxer=tta --enable-parser=aac --enable-parser=mpegaudio --enable-parser=gsm --enable-decoder=pcm_s8 --enable-decoder=pcm_s8_planar --enable-decoder=pcm_s16be --enable-decoder=pcm_s16le --enable-decoder=pcm_u16be --enable-decoder=pcm_u16le --enable-decoder=pcm_s16be_planar --enable-decoder=pcm_s16le_planar --enable-decoder=pcm_f64le --enable-decoder=pcm_f64be --enable-decoder=pcm_s24be --enable-decoder=pcm_s24daud --enable-decoder=pcm_s24le --enable-decoder=pcm_s24le_planar --enable-decoder=pcm_u24be --enable-decoder=pcm_u24le --enable-decoder=pcm_s32be --enable-decoder=pcm_s32le --enable-decoder=pcm_u32be --enable-decoder=pcm_u32le --enable-decoder=pcm_f32be --enable-decoder=pcm_f32le --enable-decoder=pcm_s32le_planar --enable-decoder=pcm_alaw --enable-decoder=pcm_mulaw --enable-decoder=adpcm_ms --enable-decoder=adpcm_g726 --enable-decoder=gsm --enable-decoder=gsm_ms --enable-decoder=adpcm_ima_qt --enable-decoder=adpcm_4xm --enable-decoder=adpcm_adx --enable-decoder=adpcm_ct --enable-decoder=adpcm_ea --enable-decoder=adpcm_ea_maxis_xa --enable-decoder=adpcm_ea_r1 --enable-decoder=adpcm_ea_r2 --enable-decoder=adpcm_ea_r3 --enable-decoder=adpcm_ea_xas --enable-decoder=adpcm_ima_amv --enable-decoder=adpcm_ima_dk3 --enable-decoder=adpcm_ima_dk4 --enable-decoder=adpcm_ima_ea_eacs --enable-decoder=adpcm_ima_ea_sead --enable-decoder=adpcm_ima_iss --enable-decoder=adpcm_ima_smjpeg --enable-decoder=adpcm_ima_wav --enable-decoder=adpcm_ima_ws --enable-decoder=adpcm_swf --enable-decoder=adpcm_xa --enable-decoder=adpcm_yamaha --enable-decoder=pcm_zork --enable-decoder=pcm_bluray --enable-decoder=pcm_lxf --enable-decoder=pcm_dvd --enable-demuxer=pcm_s8 --enable-demuxer=pcm_u8 --enable-demuxer=pcm_s16be --enable-demuxer=pcm_s16le --enable-demuxer=pcm_u16be --enable-demuxer=pcm_u16le --enable-demuxer=pcm_u16be --enable-demuxer=pcm_u24be --enable-demuxer=pcm_u24le --enable-demuxer=pcm_s24be --enable-demuxer=pcm_s24le --enable-demuxer=pcm_u32be --enable-demuxer=pcm_u32le --enable-demuxer=pcm_s32be --enable-demuxer=pcm_s32le --enable-demuxer=pcm_f32be --enable-demuxer=pcm_f32le --enable-demuxer=pcm_f64be --enable-demuxer=pcm_f64le --enable-demuxer=pcm_alaw --enable-demuxer=pcm_mulaw --cpu=armv7-a --extra-cflags='-DANDROID --sysroot=/opt/android-ndk-r10d/platforms/android-14/arch-arm -march=armv7-a -mcpu=cortex-a9 -mno-thumb-interwork -O3 -mfloat-abi=hard -mhard-float -D_NDK_MATH_NO_SOFTFP=1 -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -MMD -MP -ffunction-sections -funwind-tables -fstack-protector -Wno-psabi -fomit-frame-pointer -std=c99 -Wno-sign-compare -Wno-switch -Wno-pointer-sign -ffast-math -mno-thumb-interwork -Wa,--noexecstack -I/opt/android-ndk-r10d/platforms/android-14/arch-arm/usr/include  -mfpu=neon '
prefix=/usr/local
...
ARCH=arm
INTRINSICS=neon
CC=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
CXX=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-g++
AS=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
LD=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ranlib
STRIP=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -DANDROID --sysroot=/opt/android-ndk-r10d/platforms/android-14/arch-arm -march=armv7-a -mcpu=cortex-a9 -mno-thumb-interwork -O3 -mfloat-abi=hard -mhard-float -D_NDK_MATH_NO_SOFTFP=1 -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -MMD -MP -ffunction-sections -funwind-tables -fstack-protector -Wno-psabi -fomit-frame-pointer -std=c99 -Wno-sign-compare -Wno-switch -Wno-pointer-sign -ffast-math -mno-thumb-interwork -Wa,--noexecstack -I/opt/android-ndk-r10d/platforms/android-14/arch-arm/usr/include -mfpu=neon -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -DANDROID --sysroot=/opt/android-ndk-r10d/platforms/android-14/arch-arm -march=armv7-a -mcpu=cortex-a9 -mno-thumb-interwork -O3 -mfloat-abi=hard -mhard-float -D_NDK_MATH_NO_SOFTFP=1 -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -MMD -MP -ffunction-sections -funwind-tables -fstack-protector -Wno-psabi -fomit-frame-pointer -std=c99 -Wno-sign-compare -Wno-switch -Wno-pointer-sign -ffast-math -mno-thumb-interwork -Wa,--noexecstack -I/opt/android-ndk-r10d/platforms/android-14/arch-arm/usr/include -mfpu=neon -march=armv7-a -fPIC
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=/opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS= --sysroot=/opt/android-ndk-r10d/platforms/android-14/arch-arm -Wl,--no-whole-archive /opt/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/lib/gcc/arm-linux-androideabi/4.9/libgcc.a -Wl,--no-undefined -Wl,-z,noexecstack -L/opt/android-ndk-r10d/platforms/android-14/arch-arm/usr/lib -llog -lz -lc -Wl,--no-warn-mismatch -lm_hard  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
