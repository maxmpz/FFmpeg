...
// Begin PAMP change: use NULL_IF_CONFIG_SMALL() for options help labels
    { "ice_genre", NULL_IF_CONFIG_SMALL("set stream genre"), OFFSET(genre), AV_OPT_TYPE_STRING, { 0 }, 0, 0, E },
    { "ice_name", NULL_IF_CONFIG_SMALL("set stream description"), OFFSET(name), AV_OPT_TYPE_STRING, { 0 }, 0, 0, E },
    { "ice_description", NULL_IF_CONFIG_SMALL("set stream description"), OFFSET(description), AV_OPT_TYPE_STRING, { 0 }, 0, 0, E },
    { "ice_url", NULL_IF_CONFIG_SMALL("set stream website"), OFFSET(url), AV_OPT_TYPE_STRING, { 0 }, 0, 0, E },
    { "ice_public", NULL_IF_CONFIG_SMALL("set if stream is public"), OFFSET(public), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 1, E },
    { "user_agent", NULL_IF_CONFIG_SMALL("override User-Agent header"), OFFSET(user_agent), AV_OPT_TYPE_STRING, { 0 }, 0, 0, E },
    { "password", NULL_IF_CONFIG_SMALL("set password"), OFFSET(pass), AV_OPT_TYPE_STRING, { 0 }, 0, 0, E },
    { "content_type", NULL_IF_CONFIG_SMALL("set content-type, MUST be set if not audio/mpeg"), OFFSET(content_type), AV_OPT_TYPE_STRING, { 0 }, 0, 0, E },
    { "legacy_icecast", NULL_IF_CONFIG_SMALL("use legacy SOURCE method, for Icecast < v2.4"), OFFSET(legacy_icecast), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 1, E },
// End PAMP change
    { NULL }
};
