...
// Begin PAMP change: use NULL_IF_CONFIG_SMALL() for options help labels
    { "seekable", NULL_IF_CONFIG_SMALL("control seekability of connection"), OFFSET(seekable), AV_OPT_TYPE_INT, { .i64 = -1 }, -1, 1, D },
    { "chunked_post", NULL_IF_CONFIG_SMALL("use chunked transfer-encoding for posts"), OFFSET(chunked_post), AV_OPT_TYPE_INT, { .i64 = 1 }, 0, 1, E },
    { "headers", NULL_IF_CONFIG_SMALL("set custom HTTP headers, can override built in default headers"), OFFSET(headers), AV_OPT_TYPE_STRING, { 0 }, 0, 0, D | E },
    { "content_type", NULL_IF_CONFIG_SMALL("set a specific content type for the POST messages"), OFFSET(content_type), AV_OPT_TYPE_STRING, { 0 }, 0, 0, D | E },
    ...
    { "user-agent", NULL_IF_CONFIG_SMALL("override User-Agent header"), OFFSET(user_agent), AV_OPT_TYPE_STRING, { .str = DEFAULT_USER_AGENT }, 0, 0, D },
    { "multiple_requests", NULL_IF_CONFIG_SMALL("use persistent connections"), OFFSET(multiple_requests), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 1, D | E },
    { "post_data", NULL_IF_CONFIG_SMALL("set custom HTTP post data"), OFFSET(post_data), AV_OPT_TYPE_BINARY, .flags = D | E },
    { "mime_type", NULL_IF_CONFIG_SMALL("export the MIME type"), OFFSET(mime_type), AV_OPT_TYPE_STRING, { 0 }, 0, 0, AV_OPT_FLAG_EXPORT | AV_OPT_FLAG_READONLY },
    { "cookies", NULL_IF_CONFIG_SMALL("set cookies to be sent in applicable future requests, use newline delimited Set-Cookie HTTP field value syntax"), OFFSET(cookies), AV_OPT_TYPE_STRING, { 0 }, 0, 0, D },
    { "icy", NULL_IF_CONFIG_SMALL("request ICY metadata"), OFFSET(icy), AV_OPT_TYPE_INT, { .i64 = 1 }, 0, 1, D },
    { "icy_metadata_headers", NULL_IF_CONFIG_SMALL("return ICY metadata headers"), OFFSET(icy_metadata_headers), AV_OPT_TYPE_STRING, { 0 }, 0, 0, AV_OPT_FLAG_EXPORT },
    { "icy_metadata_packet", NULL_IF_CONFIG_SMALL("return current ICY metadata packet"), OFFSET(icy_metadata_packet), AV_OPT_TYPE_STRING, { 0 }, 0, 0, AV_OPT_FLAG_EXPORT },
    { "metadata", NULL_IF_CONFIG_SMALL("metadata read from the bitstream"), OFFSET(metadata), AV_OPT_TYPE_DICT, {0}, 0, 0, AV_OPT_FLAG_EXPORT },
    { "auth_type", NULL_IF_CONFIG_SMALL("HTTP authentication type"), OFFSET(auth_state.auth_type), AV_OPT_TYPE_INT, { .i64 = HTTP_AUTH_NONE }, HTTP_AUTH_NONE, HTTP_AUTH_BASIC, D | E, "auth_type"},
    { "none", NULL_IF_CONFIG_SMALL("No auth method set, autodetect"), 0, AV_OPT_TYPE_CONST, { .i64 = HTTP_AUTH_NONE }, 0, 0, D | E, "auth_type"},
    { "basic", NULL_IF_CONFIG_SMALL("HTTP basic authentication"), 0, AV_OPT_TYPE_CONST, { .i64 = HTTP_AUTH_BASIC }, 0, 0, D | E, "auth_type"},
    { "send_expect_100", NULL_IF_CONFIG_SMALL("Force sending an Expect: 100-continue header for POST"), OFFSET(send_expect_100), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 1, E },
    { "location", NULL_IF_CONFIG_SMALL("The actual location of the data received"), OFFSET(location), AV_OPT_TYPE_STRING, { 0 }, 0, 0, D | E },
    ...
    { "method", NULL_IF_CONFIG_SMALL("Override the HTTP method"), OFFSET(method), AV_OPT_TYPE_STRING, { .str = NULL }, 0, 0, E },
    { "reconnect", NULL_IF_CONFIG_SMALL("auto reconnect after disconnect before EOF"), OFFSET(reconnect), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 1, D },
    { "listen", NULL_IF_CONFIG_SMALL("listen on HTTP"), OFFSET(listen), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 1, D | E },
// End PAMP change
    { NULL }
};
